...
public class DrugStockInDetailDaoTest extends BaseDaoTestCase{
	
	private DrugStockInDetailDao dao;
	...
	public void findPage() {
		...
		DrugStockInDetailQuery query = newDrugStockInDetailQuery();
	...
	public static DrugStockInDetailQuery newDrugStockInDetailQuery() {
		DrugStockInDetailQuery query = new DrugStockInDetailQuery();
		...
		query.setSortColumns(null);
	  	...
	  	query.setInPlaceId(new Integer("1"));
	  	query.setInPrice(new java.lang.Float("1"));
	  	query.setInStocks(new Float("1"));
