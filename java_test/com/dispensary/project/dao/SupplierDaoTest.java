...
public class SupplierDaoTest extends BaseDaoTestCase{
	...
	public void findPage() {
		...
		SupplierQuery query = newSupplierQuery();
	...
	public static SupplierQuery newSupplierQuery() {
		SupplierQuery query = new SupplierQuery();
		query.setPageNumber(pageNumber);
		query.setPageSize(pageSize);
		query.setSortColumns(null);
		
	  	query.setSupplierName(new String("1"));
	  	query.setContacts(new String("1"));
	  	query.setPingyin(new String("1"));
	  	query.setAddress(new String("1"));
	  	query.setUserTel(new String("1"));
	  	query.setUserMobile(new String("1"));
	  	query.setUserEmail(new String("1"));
