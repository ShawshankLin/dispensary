...
public class PrescriptionInfoDetailDaoTest extends BaseDaoTestCase{
	
	private PrescriptionInfoDetailDao dao;
	...
	public void findPage() {
		...
		PrescriptionInfoDetailQuery query = newPrescriptionInfoDetailQuery();
	...
	public static PrescriptionInfoDetailQuery newPrescriptionInfoDetailQuery() {
		...
		query.setSortColumns(null);
	  	...
	  	query.setAmount(new Integer("1"));
	  	query.setTimes(new String("1"));
	  	query.setDays(new Integer("1"));
