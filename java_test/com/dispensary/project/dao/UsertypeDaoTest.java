...
public class UsertypeDaoTest extends BaseDaoTestCase{
	...
	public void findPage() {
		...
		UsertypeQuery query = newUsertypeQuery();
	...
	public static UsertypeQuery newUsertypeQuery() {
		UsertypeQuery query = new UsertypeQuery();
		query.setPageNumber(pageNumber);
		query.setPageSize(pageSize);
		query.setSortColumns(null);
		
	  	query.setUserTypeName(new String("1"));
		return query;
	}
