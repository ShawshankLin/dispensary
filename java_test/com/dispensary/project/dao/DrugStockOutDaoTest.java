...
public class DrugStockOutDaoTest extends BaseDaoTestCase{
	
	private DrugStockOutDao dao;
	...
	public void findPage() {
		...
		DrugStockOutQuery query = newDrugStockOutQuery();
	...
	public static DrugStockOutQuery newDrugStockOutQuery() {
		...
		query.setSortColumns(null);
	  	...
	  	query.setStockOutId(new String("1"));
		query.setOutDateBegin(new Date(System.currentTimeMillis()));
		query.setOutDateEnd(new Date(System.currentTimeMillis()));
	  	query.setTotal(new Integer("1"));
	  	query.setSum(new Long("1"));
