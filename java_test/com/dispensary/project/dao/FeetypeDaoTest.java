...
public class FeetypeDaoTest extends BaseDaoTestCase{
	...
	public void findPage() {
		...
		FeetypeQuery query = newFeetypeQuery();
	...
	public static FeetypeQuery newFeetypeQuery() {
		FeetypeQuery query = new FeetypeQuery();
		query.setPageNumber(pageNumber);
		query.setPageSize(pageSize);
		query.setSortColumns(null);
		
	  	query.setFeeTypeName(new String("1"));
		return query;
	}
