...
public class DrugSymptomRelationManagerTest extends BaseManagerTestCase{

	private DrugSymptomRelationManager manager;
	...
	public void crud() {
		...
		DrugSymptomRelation obj = newDrugSymptomRelation();
		manager.save(obj);
	...
	public static DrugSymptomRelation newDrugSymptomRelation() {
		DrugSymptomRelation obj = new DrugSymptomRelation();
		
	  	obj.setDrugId(new java.lang.Integer("1"));
	  	obj.setSymptomId(new java.lang.Integer("1"));
		return obj;
	}
}
