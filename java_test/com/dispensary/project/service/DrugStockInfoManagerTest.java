...
public class DrugStockInfoManagerTest extends BaseManagerTestCase{

	private DrugStockInfoManager manager;
	...
	public void crud() {
		...
		DrugStockInfo obj = newDrugStockInfo();
		manager.save(obj);
	...
	public static DrugStockInfo newDrugStockInfo() {
		DrugStockInfo obj = new DrugStockInfo();
		
	  	obj.setDrugId(new java.lang.Integer("1"));
	  	obj.setDrugPlaceId(new java.lang.Integer("1"));
	  	obj.setProductionDate(new java.util.Date(System.currentTimeMillis()));
	  	obj.setCurAmount(new java.lang.Float("1"));
		return obj;
	}
}
