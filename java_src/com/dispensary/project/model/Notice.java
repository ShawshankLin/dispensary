...
public class Notice extends BaseEntity implements java.io.Serializable{
	...
	//alias
	public static final String TABLE_ALIAS = "公告";
	public static final String ALIAS_ID = "id";
	
	public static final String ALIAS_USER_ID = "发布人";
	
	public static final String ALIAS_TITLE = "标题";
	
	public static final String ALIAS_CONTENT = "内容";
	
	public static final String ALIAS_ATTACHMENT = "附件标识";
	
	public static final String ALIAS_FILE_NAME = "附件";
	
	public static final String ALIAS_DATE = "发布日期";
	...
	@Column(name = "Title", unique = false, nullable = false, insertable = true, updatable = true, length = 4000)
	...
	@Column(name = "Content", unique = false, nullable = false, insertable = true, updatable = true, length = 4000)
	...
	@Column(name = "FileName", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
