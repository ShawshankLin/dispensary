<%@page import="com.dispensary.project.model.Symptom"%>
...
<head>
  ...
  <meta name="description" content="编辑症状页面">
  	...
  	<div class="am-cf admin-main">
		...
		<div class="admin-content">
		  ...
		  <div class="am-cf am-padding">
		    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><%=Symptom.TABLE_ALIAS%></strong> / <small>编辑</small></div>
		  </div>
		  ...
		  <div class="am-tabs am-margin" data-am-tabs>
		    ...
		    <div class="am-tabs-bd">
		      <div class="am-tab-panel am-fade" id="tab1" style="height:auto;">
		        <form class="am-form" action="${ctx}/pages/Symptom/update.do" method="post">
		        	<div class="am-g am-margin-top">
		            <div class="am-u-sm-4 am-u-md-2 am-text-right am-padding-right">
		            	<%=Symptom.ALIAS_SYMPTOM_ID%>
		            </div>
		            <div class="am-u-sm-8 am-u-md-4 am-u-end">
		              <input type="text" class="am-input-sm" name="symptomId" value="${symptom.symptomId }" readonly>
		            </div>
		          </div>		
		          <div class="am-g am-margin-top">
		            <div class="am-u-sm-4 am-u-md-2 am-text-right am-padding-right">
		            	<%=Symptom.ALIAS_SYMPTOM_NAME%>
		            </div>
		            <div class="am-u-sm-8 am-u-md-4 am-u-end">
		              <input type="text" class="am-input-sm" name="symptomName" value="${symptom.symptomName }">
		            </div>
		          </div>
		          <div class="am-g am-margin-top-sm">
		            ...
		            <select name="drugs" id="drugs" style="width:650px;height:10px" multiple  class="chosen-select-no-results" tabindex="1">
...
$("#drugs").chosen();
//获取症状药品
$.get("${ctx}/pages/DrugSymptomRelation/getSymptomDrugJSON.do?symptomId="+ ${symptom.symptomId }+ "&nocache="+ new Date().getTime(),function(data){
