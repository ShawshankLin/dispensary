...
<head>
  ...
  <title><%=Symptom.TABLE_ALIAS %>添加</title>
  <meta name="description" content="添加症状页面">
  	...
  	<div class="am-cf admin-main">
		...
		<div class="admin-content">
		  ...
		  <div class="am-cf am-padding">
		    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><%=Symptom.TABLE_ALIAS%></strong> / <small>添加</small></div>
		  </div>
		  ...
		  <div class="am-tabs am-margin" data-am-tabs>
		    ...
		    <div class="am-tabs-bd">
		      <div class="am-tab-panel am-fade" id="tab1" style="height:auto;">
		        <form class="am-form" action="${ctx}/pages/Symptom/save.do" method="post">		
		          <div class="am-g am-margin-top">
		            <div class="am-u-sm-4 am-u-md-2 am-text-right am-padding-right">
		            	<%=Symptom.ALIAS_SYMPTOM_NAME%>
		            </div>
		            <div class="am-u-sm-8 am-u-md-4 am-u-end">
		              <input type="text" class="am-input-sm" name="symptomName" required="required">
		            </div>
		          </div>
		          <div class="am-g am-margin-top-sm">
		            ...
		            <select name="drugs" class="chosen-select" data-placeholder="请选择药品" style="width:450px;" multiple>
