...
<head>
  ...
  <meta name="description" content="添加位置页面">
  	...
  	<div class="am-cf admin-main">
		...
		<div class="admin-content">
		  ...
		  <div class="am-cf am-padding">
		    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><%=DrugPlace.TABLE_ALIAS%></strong> / <small>添加</small></div>
		  </div>
		  ...
		  <div class="am-tabs am-margin" data-am-tabs>
		    ...
		    <div class="am-tabs-bd">
		      <div class="am-tab-panel am-fade" id="tab1" data-am-tabs="{noSwipe: 1}">
		        <form class="am-form" action="${ctx}/pages/DrugPlace/save.do" method="post">		
		          <div class="am-g am-margin-top">
		            <div class="am-u-sm-4 am-u-md-2 am-text-right am-padding-right">
		            	<%=DrugPlace.ALIAS_DRUG_PLACE%>
		            </div>
		            <div class="am-u-sm-8 am-u-md-4 am-u-end">
		              <input type="text" class="am-input-sm" name="drugPlace" required="required">
		            </div>
		          </div>
				  <div class="am-g am-margin-top">
		            <div class="am-u-sm-4 am-u-md-2 am-text-right am-padding-right">
				...
				<!--  
		          <div class="am-g am-margin-top">
		            ...
		            <div class="am-u-sm-8 am-u-md-4">
		              <div class="am-btn-group" data-am-button>
			              <label class="am-btn am-btn-default am-btn-xs am-active">
			                <input type=radio name="isStoreroom" value="1"> 库房
			              </label>
			              <label class="am-btn am-btn-default am-btn-xs">
			                <input type="radio" name="isStoreroom" value="2"> 药房
			              </label>
		          		</div>
		            </div>
