<%@page import="com.dispensary.project.model.Notice"%>
...
<head>
  ...
  <title><%=Notice.TABLE_ALIAS %>添加</title>
  	...
  	<div class="am-cf admin-main">
		...
		<div class="admin-content">
		  ...
		  <div class="am-cf am-padding">
		    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><%=Notice.TABLE_ALIAS%></strong> / <small>添加</small></div>
		  </div>
		
		  <div class="am-g">
		  		<form name="notice" class="am-form" action="${ctx}/pages/Notice/save.do" method="post" enctype="multipart/form-data">
