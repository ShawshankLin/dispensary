...
<title>学生每月就诊柱形图</title>
<meta name="description" content="学生每月就诊柱形图">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		if(type=='bar'){
			$("#chart").attr("src","${ctx}/pages/Charts/barChart.jsp");
		}else if(type=='line'){
			$("#chart").attr("src","${ctx}/pages/Charts/lineChart.jsp");
		}else if(type=='pie'){
			$("#chart").attr("src","${ctx}/pages/Charts/pieChart.jsp");
		}else if(type=='funnel'){
			$("#chart").attr("src","${ctx}/pages/Charts/funnel.jsp");
		}
