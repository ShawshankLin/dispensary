...
<title><%=PrescriptionInfoDetail.TABLE_ALIAS%>管理</title>
...
$(document).ready(function() {
	...
	function delBatch(){
		if($(":checked[name]").length>0){
			$("#queryForm").attr("action","${ctx}/pages/PrescriptionInfoDetail/delBatch.do").submit();
		}else{
			alert("请选择删除的行！");
		}
		return false;	
	...
	function search(){
		...
		window.location.href=encodeURI(encodeURI("${ctx}/pages/PrescriptionInfoDetail/search.do?searchType="+searchType+"&searchInfo="+searchInfo));
		return false;
	}
</script>
</head>
				...
				<div class="admin-content">
					<div class="am-cf am-padding">
						<div class="am-fl am-cf">
							<strong class="am-text-primary am-text-lg"><%=PrescriptionInfoDetail.TABLE_ALIAS%></strong>
							/ <small>管理</small>
						</div>
					</div>
						...
						<div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
							<div class="am-btn-toolbar">
								<div class="am-btn-group am-btn-group-xs">
									...
									<a  class="am-btn am-btn-default am-btn-success" href="${ctx}/pages/PrescriptionInfoDetail/getPresDetailReport.do">
					          	...
					          	<div class="am-btn-group">
								  	...
								  	<div class="am-dropdown" data-am-dropdown>
									    ...
									    <ul class="am-dropdown-content" id="searchType">
									      <li class="am-active" value="presId"><a href="javascript:void(0)"  onclick="setSearchType(this)">处方号</a></li>
									      <li value="drugId"><a href="javascript:void(0)" onclick="setSearchType(this)">药品编号</a></li>
									    </ul>
								  	</div>
							  	</div>		      
						  	</div>
					...
					<div class="am-g">
						<div class="am-u-sm-12">
							<form id="queryForm" name="queryForm" class="am-form" action="<c:url value="/pages/PrescriptionInfoDetail/list.do"/>" method="post">
								<table class="am-table am-table-striped am-table-hover table-main">
									<thead>
										<tr>											
											...
											<th sortColumn="PresID"><%=PrescriptionInfoDetail.ALIAS_PRES_ID%></th>
											<th sortColumn="DrugID">药品名称</th>
												...
												<td>
													<div class="am-btn-toolbar">
														<div class="am-btn-group am-btn-group-xs">
															    ...
															    <div class="am-modal-bd">
															    	<div style="overflow:auto;width:100%;height:300px">
															     	<table class="am-table am-table-striped am-table-hover">
																		<tr>
																			<td><%=PrescriptionInfoDetail.ALIAS_PRES_ID%></td>
																			<td>${item.presId}</td>
																		</tr>
																		<tr>
																			<td><%=PrescriptionInfoDetail.ALIAS_DRUG_ID%></td>
																			<td>${item.drugIdModel.modelTagValue}</td>
																		</tr>
																		<tr>
																			<td><%=PrescriptionInfoDetail.ALIAS_AMOUNT%></td>
																			<td>${item.amount}</td>
																		</tr>
																		<tr>
																			<td><%=PrescriptionInfoDetail.ALIAS_TIMES%></td>
																			<td>${item.times}</td>
																		</tr>
																		<tr>
																			<td><%=PrescriptionInfoDetail.ALIAS_DAYS%></td>
																			<td>${item.days}</td>
																		</tr>
																		<tr>
																			<td><%=PrescriptionInfoDetail.ALIAS_DRUG_SUM%></td>
																			<td>${item.drugSum}</td>
																		</tr>
																		<tr>
																			<td><%=PrescriptionInfoDetail.ALIAS_NOTE%></td>
																			<td>${item.note}</td>
																		</tr>
																	</table>
																	</div>
															...
															<!--  
															<a class="am-btn am-btn-default am-text-secondary" href="${ctx}/pages/PrescriptionInfoDetail/edit.do?presId=${item.presId}">
															  <span class="am-icon-pencil-square-o"></span> 编辑
															</a>
															-->
															<a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="return confirm('${ctx}/pages/PrescriptionInfoDetail/delete.do?id=${item.id}')" href="javascript:void(0)">
