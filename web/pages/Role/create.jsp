...
<head>
  ...
  <title><%=Role.TABLE_ALIAS %>添加</title>
  <meta name="description" content="添加角色页面">
		  ...
		  <div class="am-tabs am-margin" data-am-tabs="{noSwipe: 1}">
		    ...
		    <div class="am-tabs-bd">
		      <div class="am-tab-panel am-fade" id="tab1">
		        <form class="am-form" action="${ctx}/pages/Role/save.do" method="post">
		          <div class="am-g am-margin-top">
		            <div class="am-u-sm-4 am-u-md-2 am-text-right am-padding-right">
		              	<%=Role.ALIAS_ROLE_NAME%>
		            </div>
		            <div class="am-u-sm-8 am-u-md-4">
		              <input type="text" class="am-input-sm" name="roleName" id="roleName" required="required">
		            </div>
		          ...
		          <div class="am-g am-margin-top">
		            ...
		            <div class="am-u-sm-8 am-u-md-4">
		              <input type="text" class="am-input-sm" name="roleDescribe" id="roleDescribe">
		            </div>
