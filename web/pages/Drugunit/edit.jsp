<%@page import="com.dispensary.project.model.Drugunit"%>
...
<head>
  ...
  <title><%=Drugunit.TABLE_ALIAS %>编辑</title>
  <meta name="description" content="编辑药品单位页面">
  	...
  	<div class="am-cf admin-main">
		...
		<div class="admin-content">
		  ...
		  <div class="am-cf am-padding">
		    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><%=Drugunit.TABLE_ALIAS%></strong> / <small>编辑</small></div>
		  </div>
		  ...
		  <div class="am-tabs am-margin" data-am-tabs>
		    ...
		    <div class="am-tabs-bd">
		      <div class="am-tab-panel am-fade" id="tab1">
		        <form class="am-form" action="${ctx}/pages/Drugunit/update.do" method="post">
		          <div class="am-g am-margin-top">
		            <div class="am-u-sm-4 am-u-md-2 am-text-right am-padding-right">
		              	<%=Drugunit.ALIAS_DRUG_UNIT_ID%>
		            </div>
		            <div class="am-u-sm-8 am-u-md-4">
		              <input type="text" class="am-input-sm" name="drugUnitId" value="${unit.drugUnitId }" readonly>
		            </div>
		          ...
		          <div class="am-g am-margin-top">
		            <div class="am-u-sm-4 am-u-md-2 am-text-right am-padding-right">
		            	<%=Drugunit.ALIAS_DRUG_UNIT_NAME%>
		            </div>
		            <div class="am-u-sm-8 am-u-md-4 am-u-end">
		              <input type="text" class="am-input-sm" name="drugUnitName" value="${unit.drugUnitName }">
		            </div>
		          </div>
			     <div class="am-margin">
