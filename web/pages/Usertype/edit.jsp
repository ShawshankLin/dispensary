...
<head>
  ...
  <meta name="description" content="编辑用户类型页面">
  	...
  	<div class="am-cf admin-main">
		...
		<div class="admin-content">
		  ...
		  <div class="am-cf am-padding">
		    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><%=Usertype.TABLE_ALIAS%></strong> / <small>编辑</small></div>
		  </div>
		  ...
		  <div class="am-tabs am-margin" data-am-tabs>
		    ...
		    <div class="am-tabs-bd">
		      <div class="am-tab-panel am-fade" id="tab1">
		        <form class="am-form" action="${ctx}/pages/Usertype/update.do" method="post">
		
		          <div class="am-g am-margin-top">
		            <div class="am-u-sm-4 am-u-md-2 am-text-right am-padding-right">
		            	<%=Usertype.ALIAS_USER_TYPE_ID%>
		            </div>
		            <div class="am-u-sm-8 am-u-md-4 am-u-end">
		              <input type="text" class="am-input-sm" name="userTypeId" value="${usertype.userTypeId }" readonly>
		            </div>
		          </div>
		          ...
		          <div class="am-g am-margin-top">
		            ...
		            <div class="am-u-sm-8 am-u-md-4 am-u-end">
		              <input type="text" class="am-input-sm" name="userTypeName" value="${usertype.userTypeName }">
		            </div>
		          </div>
