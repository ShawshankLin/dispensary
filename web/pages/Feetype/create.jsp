...
<head>
  ...
  <meta name="description" content="添加费用类型页面">
  	...
  	<div class="am-cf admin-main">
		...
		<div class="admin-content">
		  ...
		  <div class="am-cf am-padding">
		    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><%=Feetype.TABLE_ALIAS%></strong> / <small>添加</small></div>
		  </div>
		  ...
		  <div class="am-tabs am-margin" data-am-tabs="{noSwipe: 1}">
		    ...
		    <div class="am-tabs-bd">
		      <div class="am-tab-panel am-fade" id="tab1" style="height:auto;">
		        <form class="am-form" action="${ctx}/pages/Feetype/save.do" method="post">
		          ...
		          <div class="am-g am-margin-top">
		            ...
		            <div class="am-u-sm-8 am-u-md-4 am-u-end">
		              <input type="text" class="am-input-sm" name="feeTypeName" required="required">
		            </div>
		          </div>
